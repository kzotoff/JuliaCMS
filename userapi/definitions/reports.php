...
Registry::Set('api_reports', array(
	...
	'report_clients' => array(
		...
		'main_table'    => 'clients',
		'id_field'      => 'clients_id',
		'sql_update'    => 'update clients set first_name = :clients_first_name, patronymic = :clients_patronymic, second_name = :clients_second_name, phone = :clients_phone, email = :clients_email, counter = :clients_counter, address = :clients_address, labels = :clients_labels where id = :row_id',
		...
		'fields' => array(
			...
			'clients_phone'       => array('width'=>'200'),
			'clients_email'       => array('width'=>'200'),
			'clients_counter'     => array('width'=>'80'),
			'clients_address'     => array('width'=>'80'),
	...
	'report_mailfrom' => array(
		...
		'sql_update'    => 'update mailfrom set caption = :mailfrom_caption, from_addr = :mailfrom_from_addr, server = :mailfrom_server, port = :mailfrom_port, auth_type = :mailfrom_auth_type, ehlo = :mailfrom_ehlo, login = :mailfrom_login, password = :mailfrom_password where id = :row_id',
		'context_menu'  => array(
			'record_add',
			'record_edit',
			'record_delete_confirm',
	...
	'report_templates' => array(
		...
		'editor'        => '../../userapi/xsl/editor_templates.xsl',
		'sql_update'    => 'update templates set caption = :templates_caption, message = :templates_message where id = :row_id',
	...
	'report_sms' => array(
		'caption'       => 'SMS-сообщения к отправке',
		'main_table'    => 'sms',
		'id_field'      => 'sms_id',
		'sql_update'    => 'update `sms` set `to` = :sms_to, `phone` = :sms_phone, `text` = :sms_text where id = :row_id',
