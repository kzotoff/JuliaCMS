...
function save_to_gallery_from_file($filename) {
	...
	try {
		...
		$statement->bindValue(':name',        $newname                                       , SQLITE3_TEXT);
		$statement->bindValue(':keywords',    get_as_regexp($_POST['caption'], $re_name)     , SQLITE3_TEXT);
		$statement->bindValue(':keywords',    get_as_regexp($_POST['keywords'], $re_name)    , SQLITE3_TEXT);
		$statement->bindValue(':description', get_as_regexp($_POST['description'], $re_name) , SQLITE3_TEXT);
