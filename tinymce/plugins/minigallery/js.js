...
//	$('#all_images .img_link').prettyPhoto({ social_tools:'' });
	...
	$('#b_login').click(function() { $('#loginform').dialog({ modal: true, width: 500, resizable: false, title:'Представьтесь, пожалуйста' }); });
	$('#b_login').tooltip({ bodyHandler: function() { return $('<div></div>').text('Вход') }, delay:0 });

	$('#b_logout').click(function() { location.href='auth.php?logout'; });
	$('#b_logout').tooltip({ bodyHandler: function() { return $('<div></div>').text('Выход') }, delay:0 });
	...
	$('#b_help').click(function() { $('#helpform').dialog({ modal: true, width: 500, resizable: false, title:'Справка' }); });
	$('#b_help').tooltip({ bodyHandler: function() { return $('<div></div>').text('Справка') }, delay:0 });

	$('#b_acl').click(function() { location.href = 'security.php'; });
	$('#b_acl').tooltip({ bodyHandler: function() { return $('<div></div>').text('Доступ') }, delay:0 });
